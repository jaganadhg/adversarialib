...
def main(verbose=True):
    ...
    parser = argparse.ArgumentParser(description='Learn from a single training set')
    ...
    from setup import CLASSIFIER_PARAMS, GRID_PARAMS
    ...
    for class_type, params in CLASSIFIER_PARAMS.items():
        ...
        class_fpath = join(curr_working_dir,args.output_folder,class_type)
        save_data(clf.best_estimator_, class_fpath)
        log('The "best" classifier has been saved on %s' % class_fpath)
