...
def save_test_result(exp_path, dset_folder, dset_name, test_fraction, split_no, classifier, class_type, verbose):
    ...
    fname_test, exists = get_fname_exp(exp_path, dset_name, feed_type=TESTS, exp_type=BASE,
